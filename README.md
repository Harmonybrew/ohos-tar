...
本项目为 OpenHarmony 平台编译了 GNU tar，并发布预构建包。
...
cd /root
curl -L -O https://github.com/Harmonybrew/ohos-tar/releases/download/1.35/tar-1.35-ohos-arm64.tar.gz
...
需要在 [鸿蒙容器](https://github.com/hqzing/docker-mini-openharmony) 中运行项目里的 build.sh，以实现 tar 的本地编译。
